...
**The Skilled But Stuck Editor:**

* 1-3 years editing professionally
...
* Beginners who don't know the software yet
* Agency grinders optimizing for volume
* Editors who just want quick hacks
...
* 4-6 hour workdays, not 12-hour marathons
* Time for fitness, friends, travel, life
* Financial freedom to live how you want
* Sustainable excellence, not burnout grinding

### Honesty Over Hype

* Tell editors what they need to hear, not what they want to hear
* No guru-speak, no fake scarcity, no false promises
* Direct feedback delivered with empathy
* "You're not bad at editing. You're missing the fundamentals."

### Personalization Over Automation

* Diagnostic, not generic
* Custom roadmaps for each editor's situation
...
* Say yes to better opportunities, no to everything else
...
# Section 6: How We Coach

## The Coaching Voice

How we actually talk to students. Direct but warm. Challenge with path. Never just criticism.

### Handling Vulnerability

When someone opens up about struggles, we don't rush past it:
...
### The Vulnerability Response Pattern
...
```
"Just because that gives you peace of mind that even if you make total zero, everything goes to shit, you're still not going to end up on the street. You have the time."
```

### The Compounding Reframe

When someone is stuck in "it's not working":

```
"Your efforts are actually going to be compounding on top of one another."

"At the beginning, they always suck. Always. But as you start getting momentum, it's very hard to mess it up."
```
...
```
"Totally understand that it is discouraging. Posting and then not having anything going on."
...
* Prove to family that editing is legitimate
* Make more than friends with traditional jobs
* Move to dream location (or stay, but on your terms)
...
# Section 8: How We Enroll (The Oversubscribed Philosophy)

## Full-Time Editor Is Oversubscribed

Full-Time Editor has more demand than capacity. We don't chase prospects. Prospects come to us.

This isn't arrogance. It's the natural result of building something genuinely valuable and being honest about who it's for.

```
We are not desperate to close anyone.

We have people waiting in line to join.
...
We're here to figure out if working together makes sense.
...
They exude that they will be fine with or without you.
```
...
| They Do | We Do |
| ----- | ----- |
| Chase prospects | Attract the right people |
| Convince on calls | Find mutual fit |
| Desperate to close | Fine either way |
| Artificial scarcity | Genuine demand |
...
* Magic formulas or secret hacks
...
* Vulnerability (showing your work, hearing feedback)
* Consistency (focused practice, not sporadic effort)
* Patience (fundamentals take time to master)
* Courage (leaving comfort zone)
* Trust (in the process, in yourself)
